...
class TranslationRepository {
  constructor() {
    ...
    // In development: use src/, in production: use root directory
    const srcPath = path.join(this.basePath, 'src', 'messages.local.json');
    const productionPath = path.join(this.basePath, 'messages.local.json');
    ...
    try {
      ...
      this.localMessagesPath = productionPath; // Production
    }
