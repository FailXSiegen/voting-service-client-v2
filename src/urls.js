...
export const URLS = {
  ...
  VALIDATE_PASSWORD_ENDPOINT: env.VITE_API_BASE_URL + env.VITE_VALIDATE_PASSWORD_ENDPOINT,
  REFRESH_LOGIN_ENDPOINT: env.VITE_API_BASE_URL + env.VITE_REFRESH_LOGIN_ENDPOINT,
  ...
  ORGANIZER_REQUEST_PASSWORD_CHANGE_ENDPOINT:
    env.VITE_API_BASE_URL + env.VITE_REQUEST_ORGANIZER_REQUEST_PASSWORD_CHANGE_ENDPOINT,
  ...
  ORGANIZER_EXPORT_RESULTS: env.VITE_API_BASE_URL + env.VITE_REQUEST_ORGANIZER_EXPORT_RESULTS,
