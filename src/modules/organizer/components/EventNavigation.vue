      ...
      <ul class="list-group">
        <li class="navigation-item list-group-item">
          ...
          >
            ...
            <span
              :class="['nav-icon','bi', 'bi--2xl', getRouteByName(RouteOrganizerMemberRoom)?.meta?.bootstrapIcon]"
        ...
        <li class="navigation-item list-group-item">
          ...
          >
            ...
            <span
              :class="['nav-icon','bi', 'bi--2xl', getRouteByName(RouteOrganizerLobbyRoom)?.meta?.bootstrapIcon]"
        ...
        <li class="navigation-item list-group-item">
          ...
          >
            ...
            <span
              :class="['nav-icon','bi', 'bi--2xl', getRouteByName(RouteOrganizerPolls)?.meta?.bootstrapIcon]"
        ...
        <li class="navigation-item list-group-item">
          ...
          >
            ...
            <span
              :class="['nav-icon','bi', 'bi--2xl', getRouteByName(RouteOrganizerPollResults)?.meta?.bootstrapIcon]"
...
const verifiedUsersCount = computed(() => eventUsers.value.filter((eventUser) => eventUser.verified)?.length ?? 0);
const pendingUsersCount = computed(() => eventUsers.value.filter((eventUser) => !eventUser.verified)?.length ?? 0);
