  ...
  <PageLayout>
    <template #actions>
      <div class="d-flex justify-content-between align-items-center">
        ...
        <DashboardActions @logout="onLogout" @terminate-token-session="onTerminateTokenSession" />
      </div>
    </template>
    <template #content>
...
const eventIsAsync = computed(() => props.event.async === true || props.event.async === 1);
