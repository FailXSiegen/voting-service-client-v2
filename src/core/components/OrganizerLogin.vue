<template>
  <form id="organizer-login-form" class="card p-3 border-primary" @submit.prevent="onLogin">
    <h2 class="mb-4">
    ...
    <div class="mb-3">
      <button id="organizer-login-submit" type="submit" class="btn btn-primary w-100">
        {{ $t('view.login.submit') }}
      </button>
    </div>
    <small>
