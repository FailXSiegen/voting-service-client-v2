...
const routes = [
  ...
  new Route(
    ...
    async (to) => {
      ...
      if (pageSlug && pageSlug.pageKey) {
        ...
        console.log(
          'Using GenericStaticPage with pageKey:',
          pageSlug.pageKey,
          'but keeping URL as /impressum'
        );
        return true;
      }
    ...
    async (to) => {
      ...
      if (pageSlug && pageSlug.pageKey) {
        ...
        console.log(
          'Using GenericStaticPage with pageKey:',
          pageSlug.pageKey,
          'but keeping URL as /datenschutz'
        );
        return true;
      }
    ...
    async (to) => {
      ...
      if (pageSlug && pageSlug.pageKey) {
        ...
        console.log(
          'Using GenericStaticPage with pageKey:',
          pageSlug.pageKey,
          'but keeping URL as /haeufige-fragen'
        );
        return true;
      }
    ...
    async (to) => {
      ...
      if (pageSlug && pageSlug.pageKey) {
        ...
        console.log(
          'Using GenericStaticPage with pageKey:',
          pageSlug.pageKey,
          'but keeping URL as /nutzervereinbarung'
        );
        return true;
      }
  ...
  new Route(
    '/admin/static-content-editor',
    RouteOrganizerStaticContentEditor,
    StaticContentEditorView,
    {
  ...
  new Route(
    ...
    RouteOrganizerGlobalSettings,
    () => import('@/modules/organizer/views/OrganizerGlobalSettings.vue'),
    {
  ...
  new Route('/activate-user/:eventId/:token', RouteActivateAuthToken, ActivateAuthToken),

  // Shortlink redirect route
  new Route('/s/:shortCode', RouteShortlinkRedirect, ShortlinkRedirect, null, null, true),
